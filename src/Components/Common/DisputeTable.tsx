...
const DisputeTable: React.FC<DisputeProps> = ({ exceptions, isSubmitted, setIsModalClose, refreshAnalyticsDto }) => {
        ...
        <Table
          ...
          <TableHead >
            <TableRow
              ...
              <StyledTableCellHeader>Account Payment Trans No.</StyledTableCellHeader>
