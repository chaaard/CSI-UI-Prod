...
const UnpaidTable: React.FC<AnalyticsProps> = ({ dateFrom, dateTo, customerId, status }) => {
          ...
          <Table
            ...
            >
              ...
              >
                ...
                <StyledTableCellHeader>Oracle Invoice</StyledTableCellHeader>
                <StyledTableCellHeader>Order No.</StyledTableCellHeader>
                <StyledTableCellHeader>TRX</StyledTableCellHeader>
