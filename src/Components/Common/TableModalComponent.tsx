...
const TableModalComponent: React.FC<ModalProps> = ({ open, title, children, onClose, onSave, buttonName, mode }) => {
  ...
  return (
    <Box>
      ...
      >
        <DialogTitle sx={{ color: "#1C3766", backgroundColor: '#FFFFFF', fontWeight: "bold", userSelect: 'none', cursor: 'default' }}>
          {title}
          <IconButton aria-label="close" onClick={onClose} sx={{ position: 'absolute', right: 8, top: 8 }}>
            <CloseIcon />
          </IconButton>
        </DialogTitle>
        <Divider sx={{ backgroundColor: '#FFFFFF' }} orientation="horizontal" variant="middle" flexItem />
