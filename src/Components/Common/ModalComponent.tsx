  ...
  return (
    <Box>
      <Dialog
        ...
        sx={{
          '& .MuiDialog-paper': {
            width: title === 'Input Actual' ? '710px' : title === 'Load Analytics' ? '800px' : title.includes('View Prooflist') ? '70%' : title === 'Add Partner Transaction' ? '1900px' : title === 'Submit Analytics' ? '1800px' : title.includes('View History') ? '70%' : '800px',
            maxWidth: title === 'Input Actual' ? '100%'  : title === 'Load Analytics' ? '100%' : title.includes('View Prooflist') ? '100%' : title === 'Add Partner Transaction' ? widthPercent : title === 'Submit Analytics' ? widthPercent : title.includes('View History') ? '70%' : '800px',
          },
        }}
      >
