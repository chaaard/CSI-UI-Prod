...
import IDashboardUsers from '../../Pages/DashboardMaintenance/Interface/IDashboardUsers';
import UsersUpdateInsert from '../../Pages/DashboardMaintenance/Interface/IUsersUpdateInsert';
              ...
              aria-label="spanning table">
                ...
                <TableBody >
                  ...
                  <TableRow key={index} sx={{ "& td": { border: 0 }}}>
                    <StyledTableCellBody sx={{ textAlign: 'center' }}>{row.FirstName}</StyledTableCellBody>
                    <StyledTableCellBody sx={{ textAlign: 'center' }}>{row.LastName}</StyledTableCellBody>
                    <StyledTableCellBody sx={{ textAlign: 'center' }}>{row.Username}</StyledTableCellBody>
                    <StyledTableCellBody sx={{ textAlign: 'center' }}>{row.Location}</StyledTableCellBody>
                    <StyledTableCellBody sx={{ textAlign: 'center' }}>{row.RoleName}</StyledTableCellBody>
                    <StyledTableCellBody sx={{ textAlign: 'center' }}>{row.Status ? 'Active' : 'Inactive'}</StyledTableCellBody>
