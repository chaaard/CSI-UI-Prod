...
const transactionsNavLinks: INavLink[] = [
  ...
  { icon: <img src={VolumeShopperIcon} alt="UBPizzaVoucher" style={{ width: '30px', height: '30px' }} />, label: 'UB Pizza Voucher', href: '/treasury/csi/ubpizzavoucher' },
  { icon: <img src={VolumeShopperIcon} alt="UBRebateIssuance" style={{ width: '30px', height: '30px' }} />, label: 'UB Rebate Issuance', href: '/treasury/csi/ubrebateissuance' },
  { icon: <img src={VolumeShopperIcon} alt="UBPVIssuance" style={{ width: '30px', height: '30px' }} />, label: 'UB PV Issuance', href: '/treasury/csi/ubpvissuance' },
  { icon: <img src={VolumeShopperIcon} alt="UBRenewal" style={{ width: '30px', height: '30px' }} />, label: 'UB Renewal', href: '/treasury/csi/ubrenewal' },
