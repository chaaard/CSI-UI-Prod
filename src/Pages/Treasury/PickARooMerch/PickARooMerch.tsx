...
const PickARooMerch = () => {
  ...
  useEffect(() => {
    document.title = "CSI | Pick A Roo - Merch";
  }, []);
        ...
        await api(config)
          .then(async (response) => {
            if (response.data.Item2 === "Proof list already uploaded!") {
              ...
              await fetchPickARooMerchMatch(analyticsParam);
  ...
  const fetchPickARooMerchException = useCallback(
