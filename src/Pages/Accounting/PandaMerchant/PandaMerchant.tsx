import {
  ...
  const AcctPandaMerchant = () => {
    ...
    useEffect(() => {
      document.title = "Accounting | Panda Merchant";
    }, []);
      ...
      async (portalParams: IAnalyticProps) => {
        try {
          const config: AxiosRequestConfig = {
            method: "POST",
            url: `/ProofList/GetAccountingPortal`,
            data: portalParams,
          };
    ...
    const fetchPandaMerchant = useCallback(async (anaylticsParam: IAnalyticProps) => {
      try {
        const config: AxiosRequestConfig = {
          method: "POST",
          url: `/Analytics/GetAccountingAnalyitcs`,
          data: anaylticsParam,
        };
          ...
          >
            ...
            <Box
              sx={{
                ...
                boxShadow:
                  "inset 1px 2px 8px -1px rgba(0,0,0,0.3), inset 1px -1px 8px -1px rgba(0,0,0,0.3)",
                textAlign: "center",
              ...
              >
                <Button
                  sx={{
                    ...
                    color:
                      activeButton === "Sales Transaction" ? "#fff" : "#1C2D5B",
                    backgroundColor:
                ...
                <Button
                  sx={{
                    ...
                    backgroundColor:
                      activeButton === "Payment" ? "#1C2D5B" : "transparent",
                  }}
  ...
  export default AcctPandaMerchant;