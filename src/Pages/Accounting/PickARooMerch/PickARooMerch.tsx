...
const AcctPickARooMerch = () => {
  ...
  useEffect(() => {
    document.title = "Accounting | Pick A Roo - Merch";
  }, []);
  ...
  const fetchPickARooMerchPortal = useCallback(
  ...
  const fetchPickARooMerchMatch = useCallback(
  ...
  const fetchPickARooMerch = useCallback(
    async (anaylticsParam: IAnalyticProps) => {
      try {
        const config: AxiosRequestConfig = {
          method: "POST",
  ...
  useEffect(() => {
    ...
    fetchPickARooMerch,
    fetchPickARooMerchPortal,
    fetchPickARooMerchMatch,
    selectedDateFrom,
    selectedDateTo,
    selected,
    jo,
...
export default AcctPickARooMerch;
