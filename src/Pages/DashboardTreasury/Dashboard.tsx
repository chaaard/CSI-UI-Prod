    ...
    <Box
      ...
      <PaperComponent
        ...
        total={
                  totalAmounts 
                      ? ['9999011955'].reduce(
                          (sum, key) => sum + (totalAmounts[key]?.reduce((a, b) => a + b, 0) ?? 0), 
                          0
                        ) 
                      : 0
      ...
      <PaperComponent
        ...
        total={
                  totalAmounts 
                      ? ['9999011548','9999011724','9999011785','9999011793','9999011936','9999011984'].reduce(
                          (sum, key) => sum + (totalAmounts[key]?.reduce((a, b) => a + b, 0) ?? 0), 
                          0
                        ) 
                      : 0
